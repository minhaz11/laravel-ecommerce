<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
      ...
      <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        ...
        <a class="collapse-item" href="{{route('createCategory')}}">Create New Category</a>
        <a class="collapse-item" href="{{route('manageCategory')}}">Manage Category</a>
        </div>
      </div>
    </li>
    <li class="nav-item">
      <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#productInfo" aria-expanded="true" aria-controls="collapseTwo">
        <i class="fas fa-fw fa-cog"></i>
        <span>Product info</span>
      </a>
      <div id="productInfo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          {{-- <h6 class="collapse-header">Custom Components:</h6> --}}
    ...
    <li class="nav-item">
      ...
      <div id="slider" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        ...
        <a class="collapse-item" href="{{route('manageFeatured')}}">Manage Featured Product</a>
        </div>
      </div>
    </li>
