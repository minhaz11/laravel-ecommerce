	...
	<section class="slide1">
		<div class="wrap-slick1">
			<div class="slick1">
                ...
                <div class="item-slick1 item1-slick1" style="background-image: url({{asset('uploads/product_image')}}/{{$item->productImage}});">
					<div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
						<span class="caption1-slide1 m-text1 t-center animated visible-false m-b-15" data-appear="fadeInDown" style="color:#222222;">
							New Collection 2020
						</span>

						<h2 class="caption2-slide1 xl-text1 t-center animated visible-false m-b-37" data-appear="fadeInUp" style="color:#222222;">
							New arrivals
						</h2>
				...
				<div class="col-sm-12 col-md-8 col-lg-4  m-l-r-auto">
					...
					<div class="block1 hov-img-zoom pos-relative m-b-30">
						...
						<div class="block1-wrapbtn w-size2">
							<!-- Button -->
                        <a href="{{route('cat_product',['id'=> $cat->id])}}" class="flex-c-m size2 m-text2 bg3 hov1 trans-0-4" >
								{{$cat->categoryName}}
							</a>
						</div>
                    </div>
